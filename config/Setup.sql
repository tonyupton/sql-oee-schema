...
CREATE LOGIN [oee_user] WITH PASSWORD=N'5fA5GCeeksCO/yFlBZGNbWJS9bKQT0+GVrCvVm8pi3M=', DEFAULT_DATABASE=[OEE_Database], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
GO
